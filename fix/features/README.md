...
| ---: | :---: | --- | --- | --- | --- | --- | --- |
| 1 | [ ] | ID-001 | crítica | Integridad de datos | Reparar el round trip del bundle unificado | — | [Datos y archivos](01-integridad-datos-archivos.md#id-001) |
| 2 | [ ] | ID-002 | alta | Integridad de datos / documentación | Resolver la contradicción de PDFs normativos | — | [Datos y archivos](01-integridad-datos-archivos.md#id-002) |
...
| 4 | [ ] | ID-004 | alta | Distribución / CI | Ejecutar gates WASM y Rust en CI | — | [Distribución](09-distribucion-ci-documentacion.md#id-004) |
...
| 11 | [ ] | ID-011 | media | Arquitectura | Eliminar la duplicación de Foundation en Space 3D | ID-003 | [Arquitectura](05-arquitectura-deuda-tecnica.md#id-011) |
