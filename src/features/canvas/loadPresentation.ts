...
const DISTRIBUTED_LANE_SPACING_PX = 1;
export const DISTRIBUTED_BASE_HEIGHT_PX = 62;
const DISTRIBUTED_LANE_STRIDE_PX = DISTRIBUTED_BASE_HEIGHT_PX + DISTRIBUTED_LANE_SPACING_PX;
const POINT_ARROW_HEAD_OFFSET_PX = 7;
const POINT_ARROW_LENGTH_PX = 45;
const POINT_STACK_GAP_PX = 1;
const POINT_DISTRIBUTED_GAP_PX = 1;
