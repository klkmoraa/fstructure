...
const copy = {
  es: {
    navigation: 'Navegación de FStructure', suite: 'FusionStructure', suiteHint: 'Volver a FusionStructure', home: 'Inicio', projects: 'Proyectos', templates: 'Plantillas', library: 'Biblioteca', classroom: 'Aula', import: 'Importar',
  ...
  en: {
    navigation: 'FStructure navigation', suite: 'FusionStructure', suiteHint: 'Back to FusionStructure', home: 'Home', projects: 'Projects', templates: 'Templates', library: 'Library', classroom: 'Classroom', import: 'Import',
...
/**
 * Bienvenida de FStructure (FS-A01 · Modelo 2D).
 *
 * Es la bienvenida original del solver 2D, ahora propia de su herramienta: se
