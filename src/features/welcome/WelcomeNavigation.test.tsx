...
describe('navegación por herramienta', () => {
  it('separa la landing general de las bienvenidas 2D y 3D', async () => {
    ...
    expect(screen.queryByRole('navigation', { name: 'Navegación de Plano' })).toBeNull();
    ...
    expect(screen.getByRole('navigation', { name: 'Navegación de Plano' })).toBeTruthy();
    expect(screen.getByRole('heading', { level: 1, name: 'Plano' })).toBeTruthy();
