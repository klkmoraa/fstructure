...
describe('engineeringQuotes dataset', () => {
  ...
  it('includes iconic quotes from movies, Dragon Ball, Suits, and pop culture requested by the user', () => {
    const popCultureIcons = [
      ...
      { name: 'Peter Parker', snippet: 'gran poder conlleva una gran responsabilidad' },
      { name: 'Clark Kent', snippet: 'don que se te ha dado' },
      { name: 'Bruce Wayne', snippet: 'lo que hago con mis acciones lo que me define' },
      { name: 'Tony Stark', snippet: 'correr antes de poder caminar' },
      { name: 'Steve Rogers', snippet: 'precio de la libertad' },
