...
const content = (onIntent: (kind: 'generate' | 'example' | 'first-node') => void, onNewProject: () => void): ToolHomeContent => ({
  ...
  paths: [
    ...
    { id: 'first-node', icon: Spline, label: { es: 'Colocar el primer nudo', en: 'Place the first node' },
      body: { es: 'Empieza vacío y escribe las coordenadas X, Y, Z.', en: 'Start empty and type the X, Y, Z coordinates.' },
