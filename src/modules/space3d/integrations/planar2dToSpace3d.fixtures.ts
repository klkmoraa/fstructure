...
const candidate = (): Space3DProjectV1 => ({
  analysisSpace: 'space-3d', schemaVersion: 2, id: 'fixture-planar-lossy', name: 'Fuente 2D con revisión', units: 'kN-m',
  nodes: [
  ...
  nodalLoads: [], loadCases: [], loadCombinations: [], prescribedDisplacements: [], memberLoads: [],
  memberInitialEffects: [], nodeLinks: [], multiPointConstraints: [], nodalMasses: [], generatedLoadSources: [], movingLoadCases: [],
});
